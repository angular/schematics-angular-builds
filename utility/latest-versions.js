...
exports.latestVersions = {
    ...
    DevkitBuildAngular: '^21.0.0-next.0+sha-f54cdff-with-local-changes',
    AngularBuild: '^21.0.0-next.0+sha-f54cdff-with-local-changes',
    AngularSSR: '^21.0.0-next.0+sha-f54cdff-with-local-changes',
};
